...
Figure 1: Relationship between the Number of Reviews per Listing and Price level.
  ...
  From the graph above, we cannot see any strong correlation between price and number of reviews. Therefore, it can be predictor of the price, but we are not sure if it will be one.
...
Figure 2: Relationship between Minimum number of nights host requires and price.
  ...
  From this graph , listings of median price level and high price level are having more required minimum nights as 3 than the low, but other than that, it is hard to observe anything. Therefore, from this graph, we cannot be sure whether the minimum number of nights is a predictor of the price. 
